...
public class Axis {
    ...
    ArrayList<GenData> dataArrayList;

    Axis(PApplet app, int x1 , int y1 , int x2 , int y2, boolean isyAxis, ArrayList<GenData> dataArrayList,  float xInt, float yInt, int minorTick) {
        pApplet = app;
        this.x1 = x1;
        this.x2 = x2;
        this.y1 = y1;
